...
- Change the report to assess something you find difficult in your repository: your issue blacklog, your CI setup, your testing, performance, possible new features, or all of these.
